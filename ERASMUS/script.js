...
//SPRAWDZIC RADIUS CZY SCIANY NIE ZNIKAJA PRZEZ TO 
//rectangle Array [x,y,z,rx,ry,rz,w,h,color]
var map = [
    [0, 0, -1000, 0, 0, 0, 2000, 200, "Patterns/goth.jpg"],  // front wall
    [0, 0, 1000, 0, 180, 0, 2000, 200, "Patterns/goth.jpg"], // back wall (obrócona 180)
    ...
    //=======WALLS=====
    //wall 1 
    [-550, 0, 850, 0, 0, 0, 900, 200, "Patterns/goth2.jpg"],
    [-550, 0, 810, 0, 0, 0, 900, 200, "Patterns/goth2.jpg"],
    ...
    //wall 2
    [800, 0, 845, 0, 90, 0, 300, 200, "Patterns/goth.jpg"],
    [760, 0, 845, 0, 90, 0, 300, 200, "Patterns/goth.jpg"],
   ...
   //wall 21 
    ...
    //PNG DECORATIONS
    //SIDE NOTE WHY DOES IT DISAPPEAR WHEN APROACHING?????
...
var lock = false;
var canlock = false;
//var speed = 1; NIE USTAWIAM GLOBALNEGO SPEED 
...
function update() {
    ...
    //wyczysc ruch myszy dopiero po uzyciu 
    MouseX = 0;
    MouseY = 0;
